...
I hold weekly consultation hours during the semester:
 ...
 + **Fridays 1—2pm** (from week 3 onward).
...
Below is the class-developed group working Code of Conduct that you are expected to adhere to during each activity in BIOSCI738. This was developed by you as a class during the first lecture.

<div class="alert alert-success" role="alert">

**BIOSCI738 group-working Code of Conduct**

In your own words (*with some style amendments by Charlotte*):

 + Introduce yourself at the beginning of the session. 
 + Listen to each other and respect others opinions.
 + Contribute *equally* to tasks. (Note: No one expects a perfectly equal distribution of contributions, but it is expected that everyone does their best to fulfill their responsibilities.)
 + **Communicate**:
    + Allow time for everyone to speak during group discussions
    + Ensure that you aren't "taking over" a task. This can be frustrating for all parties. 
    + Make sure to keep your team members up-to-date with the status of your task.
    + Ask each other for input.
    + Understand that language barriers exist and be patient and understanding of everyone in the group and make sure to check up on the members to make sure everyone has a voice!
 + **Ask about** and **use** the group's collective knowledge before turning to the internet!
 + Be open to learning new ways of coding from your peers.
 + Be **transparent** with your team members about the use of gen AI tools (and equivalent). 
    + Before you set to a task discuss the groups' opinion on their use and decide as a group if you will use them and how.
    + If as a group you decide to use gen AI and it offers an alternative method for coding (say) make sure to critique the generated response as a group and use it as a learning opportunity.
