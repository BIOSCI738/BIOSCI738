...
If you feel the need to brush up on your `R` skills here are two resources I'd recommend giving a whorl 1) [RStudio Education](https://education.rstudio.com/learn/beginner/) and 2) [`R` for Data Science](https://r4ds.had.co.nz/). There are plenty of others out there so if these don't suit you then I'd strongly encourage you to try some others until you find something that suits your learning style.

#### Lectures {-}

<span><strong>Lectures are weekly</span></strong> 
 <ul>
  <li>**Mondays**: 4–6 pm (Building 303, Room 153), and </li>
  <li>**Wednesdays**: 2–4 pm (Building 303, Room G14). </li>
</ul>
...
I hold weekly consultation hours during the semester (teaching weeks), which will follow each lecture:

 + **Mondays 6—7pm**, &
 + **Wednesdays 4—5pm**.
 
These are held in my office in **building 303, room 318**, where I'll be heading directly after the lecture!. If you are unable to make these times just email me @ [c.jonestodd@auckland.ac.nz](c.jonestodd@auckland.ac.nz) and we can sort something else out.

#### Assessment summary {-}

<div class="alert alert-danger" role="alert">

<span><strong>There is no test or exam for this course</span></strong> However, note that Interactive Oral Assessment - Assignment Discussion is a compulsory must-pass assessment. Students who do not obtain a passing grade in this assessment (i.e., 50% or over) will not pass the course, regardless of their overall course mark.

</div>

![Overview of assessment timeline. *This (Interactive Oral Assessment - Assignment Discussion) is a compulsory must-pass assessment. Students who do not obtain a passing grade in this assessment (i.e., 50% or over) will not pass the course, regardless of their overall course mark](img/gnatt.png)
...
#### Class developed Code of Conduct {-}

Below is the class-developed group working Code of Conduct that you are expected to adhere to during each activity in BIOSCI738.

<div class="alert alert-success" role="alert">

**BIOSCI738 group-working Code of Conduct**

At the beginning of each lecture you should **sort yourselves into groups** following [these instructoins](https://biosci738.github.io/biosci738_runsheets/#sec-groups).
...
In addition, the key points you, as a class, emphasised and expect each other to abide by include

 + Being friendly, kind, patient, and respectful.
 + Ensuring open, respectful communication with active listening.
 + Valuing all ideas, aka *no stupid questions* especially when everyone is learning together!
 + Discussing and sharing code/ideas clearly and openly so that all group members understand before moving on.
 + Taking responsibility for completing personal tasks on time.
 + Talking as a group about how you’d like to use AI, and if you choose to use it, making sure everyone engages with and understands the AI‑generated code or explanations.
...
**Do I need to attend all lectures?** *Yes. You should only miss class in cases of emergencies or serious illness. Otherwise, I expect you to be there, just as you’d expect me to be!*
...
**Can I use Gen AI tools in this class?** *It depends! Please refer to the [Academic honesty] section with regards to submitted work. You are also expected to abide by [UoAs academic integrity policy](https://www.auckland.ac.nz/en/students/forms-policies-and-guidelines/student-policies-and-guidelines/academic-integrity-copyright/about-academic-integrity.html) and I strongly recommend that you  follow this [advice for students on using Generative Artificial Intelligence in coursework](https://www.auckland.ac.nz/en/students/forms-policies-and-guidelines/student-policies-and-guidelines/academic-integrity-copyright/advice-for-student-on-using-generative-ai.html). Please refer to the [Class developed Code of Conduct] section in regards to use of these tools in class room activities.*

**What are the assignments for this course?** *Please refer to the [Assessment summary] section and the [Assignments tab on CANVAS](https://canvas.auckland.ac.nz/courses/141056/assignments).*
