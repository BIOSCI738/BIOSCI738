...
+ **Explain** what an `R` package is; distinguish between the functions `install.packages()` and `require()`
...
+ [Indigenous Data Sovereignty and Policy](https://require.oapen.org/handle/20.500.12657/42782)
