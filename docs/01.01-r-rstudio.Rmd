...
#### Software carpentry installation videos

```{r, echo = FALSE, out.width = "45%"}
knitr::include_url("https://www.youtube.com/watch?v=5-ly3kyxwEg", height = "200px")
```

```{r, echo = FALSE, out.width = "45%"}
knitr::include_url("https://www.youtube.com/watch?v=q0PjTAylwoU", height = "200px")
