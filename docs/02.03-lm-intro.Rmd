...
![](https://cran.r-project.org/web/packages/palmerpenguins/readme/man/figures/culmen_depth.png){width=30%}
...
<p align="center">![](https://pbs.twimg.com/media/EeMWb7QWsAIGftR?format=jpg&name=small){width=50%}</p>
