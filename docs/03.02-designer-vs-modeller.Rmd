...
1) Extracting the main effect rows that have been adjusted for the other model terms from two Type I $SS$ tables (each one haveing the terms specifed in a different order):
