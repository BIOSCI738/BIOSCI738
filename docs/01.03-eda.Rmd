...
These data are included in the `R` package `palmerpenguins`; to access the data and follow along with this, and following, sections you should first install the package using `install.packages("palmerpenguins"`). Then remember to load the package, using `library(palmerpenguins)`, into your workspace each new `R` session in which you wish to use these data.
