...
## request (download) the tidyverse packages from the centralised require
## you only need to do this once per computer :-)
install.packages("tidyverse")

```

To tell your computer to access the `tidyverse` functionality in your session run `r require(tidyverse)` (**Note** you'll have to do this each time you start up an `R` session):

```{r, echo = TRUE, eval = TRUE}
## Get the tidyverse packages from our local require
require(tidyverse)
...
```{r}
require(palmerpenguins) ## contains some nice penguin data
penguins
```
