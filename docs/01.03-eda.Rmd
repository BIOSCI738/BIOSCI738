...
In this section we will be using dataset refering to the age and shell lengths of different P$\overline{\text{a}}$ua. The dataset contains the following variables
...
Why ensure that your data is `tidy`?  1) **Consistency:** using a consistent format aids learning and reproducibility 2), **Simplicity:** it's a format that is well understood by `R`.
