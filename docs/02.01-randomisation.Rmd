...
of deducing properties of an underlying distribution by analysis of data. The word **inference** means *conclusions* or *decisions*. Statistical inference is about drawing conclusions and making decisions based on observed data.
...
Suppose we know that our random variable is (say) $\text{Binomial}(10, p)$, for some $p$, but we don't know the value of $p$.  We will see how to estimate the value of $p$ using maximum likelihood estimation in a later module..

#### Expectation and variance of a random variable:

The **expectation** of a random variable is the value it takes on **average**. The  **variance** of a random variable measures how much the random variable **varies about its average.**
