---
title: "BIOSCI738"
subtitle: "![](../intro/img/uoa.png){width=5%} Universty of Auckland"
...
```{r boxes, echo = FALSE,results='asis',fig.show='asis',warning = FALSE}
...
require(gridExtra,quietly = TRUE) ## nice package to arrange ggplots
